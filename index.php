        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name=genre value=football id="sport1">
                    <label class="form-check-label" for="sport1">
                        Football
                    </label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name=genre value=handball id="sport2">
